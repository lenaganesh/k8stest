...
@ConfigurationParameter(key = PLUGIN_PROPERTY_NAME,  value="pretty,html:target/cucumber, json:target/cucumber-execution.json")//"${plugin_property_name}"): tried this not working
